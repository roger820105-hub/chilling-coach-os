...
module.exports=async function(req,res){
 try{
  ...
  const [student,packages,sessions,exercises,measurements,assessments,plans]=await Promise.all([
  ...
  res.json({student:student[0],packages,sessions,exercises,measurements,assessments,plans});
